.. _pxb.installing/docker.running:

Running |percona-xtrabackup| in a |docker| container
********************************************************************************

A Docker container can be considered a lightweight execution environment. , Run |percona-xtrabackup| in a |docker| container without
installing it. All required libraries come already installed in
the container.
...
intend to use the same data as the *percona-server-mysql* container.
